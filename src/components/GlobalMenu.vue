<template>
    <aside class="side">
        <a href="./">
            <img class="logo" src="https://akinening.github.io/bookmark/assets/logo.svg" alt="Spott">
        </a>
        <nav class="menu">
            <a class="menu__list menu__list--active" href="./">TOP</a>
            <a class="menu__list" href="./icon">アイコン</a>
